...
const PasswordStrengthMeter = ({ password }) => {
    ...
    return (
        ...
        <>
            <div className = "progress" style={{height: '10px', width: '183px', marginTop: '3px', marginLeft: '10px'} }>
                <div className="progress-bar" style={changePasswordColor()}></div>
            </div>
                <p style={{ color: progressColor(), display: 'flex', marginLeft: '10em', fontSize: '12px', }} >{createPasswordLabel()}</p>
        </>
    )
}
